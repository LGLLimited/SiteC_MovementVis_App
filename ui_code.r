...
ui <- fluidPage(
  ...
  titlePanel(
    title=img(src="BC-Hydro-Logo.png",height="56px",width="100px",style="float: right;"),
      ...
      fluidPage(
        ...
        fluidRow(
          ...
          column(width=4,style="padding:0px;text-align:center;",offset=0,
            ...
            img(src="airplane.png",width="90%",title="Fixed-wing aircraft with radio antenna for mobile tracking.",
                style="padding-bottom:10px;")
          ),
          #br(),
          column(width=4,offset=0,style="padding:0px;text-align:center;",
            img(src="Antenna.png",width="90%",title="A fixed-station antenna on the Peace River.",
                style="padding-bottom:10px;"),
            img(src="Moberly River 2.JPG",width="90%",title="Helicopter for mobile tracking.",
                style="padding-bottom:10px;")
          )
        )
      )
...
# TEXT OUTPUT FOR WELCOME PAGE
    tabPanel("Map",
      ...
      div("The fixed array has been operated from April through October each year since 2019.",
