# UI ####
ui <- fluidPage(titlePanel(title=img(src="BC-Hydro-Logo.png",height="56px",width="100px",style="float: right;"),windowTitle="Site C Fish Movement"),
                tabsetPanel(id="main",
                            tabPanel("Data description",
                                     fluidPage(
                                       titlePanel(h1("Site C Fish Movement Assessment",align='center')),
                                     fluidRow(column(width=4, data_description()),
                                     column(width=8,img(src="Project.jpg",width="50%",style="float: right; padding-right: 200px",title="Site C Project"))),
                                     br(),
                                     fluidRow(column(width=4),
                                     column(width=8,img(src="Antenna.jpg",title="A fixed-station antenna on the Peace River.", width="50%",style="float: right; padding-right: 200px"))))),
